...
AFRAME.registerComponent("flying-birds", {
    init: function () {
        for (var i = 1; i <= 20; i++) {
            //for writing and assigning different id to different birds
            //dollar symbol is used to get the value of i variables
            var id = `hurdle${i}`;
    ...
    flyingBirds: (id, position) => {
        ...
        //query-selector--> It is used to return the elements that matches with the round brackets work in queryselector
        ...
        birdEl.setAttribute("gltf-model", "assets/bird/scene.gltf");
